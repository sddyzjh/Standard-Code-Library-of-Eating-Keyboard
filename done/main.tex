...
\usepackage{amsmath}
\usepackage{geometry}
%\geometry{papersize={297mm,250mm}}
...
\subsection{可持久化并查集}
\lstinputlisting[language=C++]{datastructure/可持久化并查集.cpp}
\subsection{可持久化线段树}
...
\subsection{完全背包}
\lstinputlisting[language=C++]{dp/完全背包.cpp}
\subsection{斜率DP}
...
\subsection{线性规划}
\lstinputlisting[language=C++]{math/线性规划.cpp}
\subsection{线性基}
...
\subsection{魔法求递推式}
\lstinputlisting[language=C++]{others/魔法求递推式.cpp}
\input{others/综合.tex}
